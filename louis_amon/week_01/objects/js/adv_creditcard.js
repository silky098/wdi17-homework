...
var lunAlgorithm = function( str ) {
  var creditCard = str.replace(RegExp('-', 'g'), '');
  var card = creditCard.split('');
  var lessOneNumber = card.pop().join();
  var newCard = '';
  for(var i = lessOneNumber.length - 1; i >= 0; i-- ) {
    newCard += lessOneNumber[i];
  }
}
...
console.log( validateCreditCard ( '4556-7375-8689-9855' ) );
/*
